  ...
  return (
    <div className="flex-row h-full justify-between my-5 px-5 border-r">
      <img
        ...
        className="sm:h-4 lg:h-6 sm:ml-6 mt-4 mb-16 cursor-pointer object-contain"
        alt="logo"
      />
      ...
      <div className="xl:ml-5">
        ...
        <div className="flex items-center p-3 mt-64 h-4 cursor-pointer hover:bg-gray-200 rounded-md hover:text-gray-100">
